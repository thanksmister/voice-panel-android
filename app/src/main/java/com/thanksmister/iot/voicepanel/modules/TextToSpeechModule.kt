...
class TextToSpeechModule( base: Context?, private val listener: TextToSpeechListener) : ContextWrapper(base),
        TextToSpeech.OnInitListener, LifecycleObserver {

    interface TextToSpeechListener {
        fun onTextToSpeechInitialized()
        fun onTextToSpeechError()
    }
